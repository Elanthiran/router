  ...
  return (
    <div>
      <div className="container d-flex justify-content-center mt-4 bg-dark ">
        ...
        <Link  className="text-decoration-none text-light mx-3" to={"/"}>All</Link>
        <Link className="text-decoration-none text-light mx-3" to={"/cybersecurity"}>CyberSecurity</Link>
        <Link className="text-decoration-none text-light mx-3" to={"/datascience"}>DataScience</Link>
        <Link className="text-decoration-none text-light mx-3" to={"/career"}>Career</Link>
        <Link className="text-decoration-none text-light mx-3" to={"/fullstack"}>FullStack</Link>
      </div>
    
      

   <Routes>
    <Route element={< All data={data}/>} path="/" />
    <Route element={<CyberSecurity data={data}/>} path="/cybersecurity" />
    <Route element={<DataScience data={data}/>} path="/datascience" />
    <Route element={<Career data={data}/>} path="/career" />
    <Route  element={<FullStack data={data}/>} path="/fullstack" />
   </Routes>
   </div>
  )
}
